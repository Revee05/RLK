...
Route::get('/checkout/success', function(){ return 'Pembayaran berhasil!'; })->name('checkout.success');
Route::get('/checkout/failed', function(){ return 'Pembayaran gagal!'; })->name('checkout.failed');

// =============================
// LELANG (AUCTION)
// =============================
Route::get('/lelang', function () { return view('web.LelangPage.lelang'); })->name('lelang');
...
// MERCHANDISE PRODUCT
// =============================
Route::get('/all-other-product', function () { return view('web.productsPage.MerchAllProductPage'); })->name('all-other-product');
Route::get('/detail-products', function () { return view('web.productsPage.MerchDetailProductPage'); })->name('detail-products');
...
// API LOKASI & ALAMAT
// =============================
Route::get('/get-kabupaten/{id}', function($id){ return \App\Kabupaten::where('provinsi_id', $id)->get(); });
