<ul class="navbar-nav bg-gradient-primary sidebar sidebar-toggled toggled sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseMerch" class="collapse @yield('collapseMerch')" aria-labelledby="headingTwo"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item @yield('addmerchproduct')" href="{{ route('master.merchProduct.create') }}">Add
                    Merchandise Product</a>
                <a class="collapse-item @yield('merchproduct')" href="{{ route('master.merchProduct.index') }}">All
                    Merchandise Products</a>
                <a class="collapse-item @yield('merchcategory')"
                    href="{{ route('master.merchCategory.index') }}">Categories</a>
            </div>
        </div>
    </li>
