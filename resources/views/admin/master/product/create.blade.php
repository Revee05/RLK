                    ...
                    <div class="row">
                            ...
                            <div class="card rounded-0 shadow">
                                <div class="card-body">
                                    <div class="preview-cover mb-2">
                                        <img class="border-1 @if(old('type') == 'featured') img-featured @else img-normal @endif" src="{{asset('assets/img/default.jpg')}}" id="foto-barang-satu-normal">
                                        <img class="border-1 img-featured d-none" src="{{asset('assets/img/default.jpg')}}" id="foto-barang-satu-featured">
                                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card rounded-0 shadow">
                                <div class="card-body">
                                    <div class="preview-cover mb-2">
                                        <img class="border-1 @if(old('type') == 'featured') img-featured @else img-normal @endif" src="{{asset('assets/img/default.jpg')}}" id="foto-barang-dua-normal">
                                        <img class="border-1 img-featured d-none" src="{{asset('assets/img/default.jpg')}}" id="foto-barang-dua-featured">
                                    </div>
                                    <div class="media-body m-auto">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="card rounded-0 shadow">
                                <div class="card-body">
                                    <div class="preview-cover mb-2">
                                        <img class="border-1 @if(old('type') == 'featured') img-featured @else img-normal @endif" src="{{asset('assets/img/default.jpg')}}" id="foto-barang-tiga-normal">
                                        <img class="border-1 img-featured d-none" src="{{asset('assets/img/default.jpg')}}" id="foto-barang-tiga-featured">
                                    </div>
                                    <div class="media-body m-auto">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card rounded-0 shadow">
                                <div class="card-body">
                                    <div class="preview-cover mb-2">
                                        <img class="border-1 @if(old('type') == 'featured') img-featured @else img-normal @endif" src="{{asset('assets/img/default.jpg')}}" id="foto-barang-empat-normal">
                                        <img class="border-1 img-featured d-none" src="{{asset('assets/img/default.jpg')}}" id="foto-barang-empat-featured">
                                    </div>
                                    <div class="media-body m-auto">
