...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                {{ Form::model($teamMember, ['route' => ['master.team.update', $teamMember->id], 'method' => 'PUT', 'files' => true]) }}
                <div class="card rounded-0 border-0 shadow">
                    <div class="card-body">
                        ...
                        <div class="preview-cover mb-3">
                            <img class="border-1"
                                @if (isset($teamMember) && $teamMember->avatar) src="{{ asset($teamMember->avatar) }}" @else src="{{ asset('assets/img/default.jpg') }}" @endif
                                id="foto-avatar">
                        </div>
