        ...
        <div class="row">
            ...
            <div class="col-md-7">
                    ...
                    <label class="shipping-item">
                        <div class="shipping-left">
                            ...
                            <div class="shipping-desc">
                                ...
                                Anda akan mendapat konfirmasi ketika pesanan siap diambil. Harap tunjukkan bukti pemesanan saat pengambilan.
                            </div>
                        </div>
                ...
                <div class="note-wrapper mb-4" id="noteWrapper">
                    ...
                    <textarea name="note" id="noteArea" class="note-input hidden"
                            maxlength="200" placeholder="Tulis catatan..."></textarea>
                </div>
            </div>
