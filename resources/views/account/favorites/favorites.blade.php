...
<div class="container" style="max-width:1200px; margin-top:40px; margin-bottom:80px;">
    <div class="row g-4 align-items-stretch"><!-- gunakan bootstrap align-items-stretch -->

        @include('account.partials.nav_new')

        <div class="col-sm-9 account-right d-flex flex-column">
            <div class="card content-border h-100 d-flex flex-column"><!-- card mengisi tinggi kolom -->
                ...
                <div class="card-body overflow-auto" style="max-height: calc(100vh - 240px);">
                    <div class="row">
